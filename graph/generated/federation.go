...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "FrameSide":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "FrameSide": %w`, err)
			}
			switch resolverName {
			...
			case "findFrameSideByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findFrameSideByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindFrameSideByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "FrameSide": %w`, err)
				}
		...
		case "Hive":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Hive": %w`, err)
			}
			switch resolverName {
			...
			case "findHiveByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findHiveByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindHiveByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Hive": %w`, err)
				}
...
func entityResolverNameForFrameSide(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
	...
	return "", fmt.Errorf("%w for FrameSide", ErrTypeNotFound)
}

func entityResolverNameForHive(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
	...
	return "", fmt.Errorf("%w for Hive", ErrTypeNotFound)
}
